...
import { Dropdown, Form, Header, Label, TextArea } from "semantic-ui-react";
...
const serviceLocation = [
  {
    key: "AtBusiness",
    text: "Available at the specified address",
    value: "atBusiness"
  },
  {
    key: "AtClientPlace",
    text: "Available at client's location",
          ...
          <div className="ui grid">
            ...
            <div className="row">
              <div className="eight wide column">
                <input
                  placeholder={
                    requiredFields.indexOf("appointmentName") > -1
                      ? "Appointment Name *"
                      : "Appointment Name"
                  }
                ...
                {this.state.error &&
                  errorFields.indexOf("appointmentName") > -1 && (
            ...
            <div className="row">
              <div className="eight wide column">
                <input
                  placeholder={
                    requiredFields.indexOf("durationInMinute") > -1
                      ? "Duration (Minutes) *"
                      : "Duration (Minutes)"
                  }
                ...
                />
                {this.state.error &&
                  errorFields.indexOf("durationInMinute") > -1 && (
                    <Label basic color="red">
            ...
            <div className="row">
              <div className="eight wide column">
                <input
                  placeholder={
                    requiredFields.indexOf("price") > -1
                      ? "Price ($100.00) *"
                      : "Price ($100.00)"
                  }
                  name="price"
            ...
            <div className="row">
              <div className="eight wide column">
                <Dropdown
                  placeholder={
                    requiredFields.indexOf("serviceLocation") > -1
                      ? "Service Location *"
                      : "Service Location"
                  }
                    ...
                    this.dataOnChange({
                      ...
                      value:
                        result.value === null || result.value === undefined
                          ? ""
                          : (result.value as Array<string>).join(",")
                    });
                    this.setState((state, props) => ({ update: true }));
                  }}
                />
                {this.state.error &&
                  errorFields.indexOf("serviceLocation") > -1 && (
                    <Label basic color="red">
